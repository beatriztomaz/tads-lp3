...
import br.edu.ifsp.orderflow.events.headlers.PagamentoAprovadoNotificacaoHeadler;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        INotificacaoService notificationService = new ConsoleNotificacaoService();
        IPagamentoGateway pagamentoGateway = new FakePagamentoGateway();
        IEventBus eventBus = new SimpleEventBus();

        PagamentoAprovadoNotificacaoHeadler evento1Handler = new PagamentoAprovadoNotificacaoHeadler(
                pedidoRepository,
                notificationService
        );
